...
namespace TextbasedRPG.Core.Areas
{
    /// <summary>
    /// Options we will provide to the user in <see cref="Market"/>
    /// </summary>
    ...
    /// <summary>
    /// Represents an area a <see cref="Player"/> can purchase / sell items at
    /// </summary>
    public class Market : Area
    {
        ...
        /// <summary>
        /// The stock of items on hand for this instance
        /// </summary>
        public Inventory Inventory { get; set; }

        /// <inheritdoc/>
        public override void Enter(ref Player player, Area previous = null)
        {
            Player = player;
